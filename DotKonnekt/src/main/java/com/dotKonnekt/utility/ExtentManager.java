...
public class ExtentManager {
	...
	public static void setExtent() throws IOException {
		...
		htmlReporter= new ExtentSparkReporter("C:\\Users\\garvi\\eclipse-workspace\\DotKonnekt\\test-output\\ExtentReport\\"+ Action.getCurrentTime() +"MyReport.html")
				.viewConfigurer().viewOrder().as(new ViewName[] {ViewName.DASHBOARD,ViewName.TEST,ViewName.CATEGORY,} ).apply();
		htmlReporter.loadXMLConfig("C:\\Users\\garvi\\eclipse-workspace\\DotKonnekt\\extent.config.xml");
